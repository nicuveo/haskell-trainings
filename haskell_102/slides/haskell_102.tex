...
\end{TopAlign}
  ...
  \alt<2>{%
    \Image{4cm}{img/replace_me_with_anything_you_want}
  }{%
    \Image{4cm}{img/replace_me_with_anything_you_want}
  }
}%
...
\Image<1-6,8-9>{4cm}{img/replace_me_with_anything_you_want}
\Image<7>{4.2cm}{img/replace_me_with_anything_you_want}
\Image<10>{4cm}{img/replace_me_with_anything_you_want}
}
\end{frame}
...
getPhoneNumber :: User -> Maybe PhoneNumber
  ...
  \begin{center}
  \vspace{2.22cm}
  \hspace{4cm}\Image{4cm}{img/replace_me_with_anything_you_want}
  \end{center}
  \end{onlyenv}
  \begin{onlyenv}<2>
  \begin{code}
...
getNextOfKinPhoneNumber :: Id -> Maybe PhoneNumber
  ...
  \begin{center}
  \vspace{.57cm}
  \hspace{3cm}\Image{4cm}{img/replace_me_with_anything_you_want}
  \end{center}
  \end{onlyenv}
  \begin{onlyenv}<3>
  \begin{code}
...
getNextOfKinPhoneNumber userId = case getUser userId of
  ...
  \begin{center}
  \vspace{0.24cm}
  \Image{3cm}{img/replace_me_with_anything_you_want}
  \end{center}
  \end{onlyenv}
  \begin{onlyenv}<6>
  \begin{code}
...
getNextOfKinPhoneNumber userId = case getUser userId of
  ...
  \begin{center}
  \vspace{.09cm}
  \Image{2.2cm}{img/replace_me_with_anything_you_want}
  \end{center}
  \end{onlyenv}
  \begin{onlyenv}<9>
  \begin{code}
...
\Image<1,7>{4.2cm}{img/replace_me_with_anything_you_want}
\Image<2-5>{4cm}{img/replace_me_with_anything_you_want}
\Image<6>{4.2cm}{img/replace_me_with_anything_you_want}
\only<8>{\vspace{0.2cm}}
\Image<8>{3.8cm}{img/replace_me_with_anything_you_want}
\only<9>{\vspace{0.2cm}}
\Image<9>{3.8cm}{img/replace_me_with_anything_you_want}
\only<10>{\vspace{0.2cm}\hspace{-0.5cm}}
\Image<10>{3.8cm}{img/replace_me_with_anything_you_want}
}
\end{frame}
...
\end{onlyenv}
  ...
  \begin{center}%
    \vspace{2cm}
    \Image{4.2cm}{img/replace_me_with_anything_you_want}
  \end{center}%
  \end{minipage}
  \>%
\)%
...
\({c}%
  ...
  \begin{center}%
    \vspace{2cm}
    \Image<1-3>{4cm}{img/replace_me_with_anything_you_want}
    \Image<4-5>{4cm}{img/replace_me_with_anything_you_want}
    \Image<6>{4cm}{img/replace_me_with_anything_you_want}
    \Image<7>{4cm}{img/replace_me_with_anything_you_want}
  \end{center}%
  \end{minipage}
  \>%
  \<{.74\linewidth}%
...
\vspace{-1.9cm}
\hspace{6.2cm}
\Image{2.8cm}{img/replace_me_with_anything_you_want}
\end{onlyenv}
\begin{onlyenv}<10>
\begin{code}
data Color = Red | Green | Blue
...
\({c}%
  ...
  \begin{center}%
    \vspace{1cm}
    \Image<2>{1.8cm}{img/replace_me_with_anything_you_want}
  \end{center}%
  \end{minipage}%
  \>%
  \<{.6\linewidth}%
...
\end{onlyenv}
  ...
  \begin{center}%
    \Image<2>{3cm}{img/replace_me_with_anything_you_want}
  \end{center}%
  \end{minipage}
  \>%
\)%
...
\end{flushleft}
  ...
  \begin{flushleft}%
    \vspace{-0.75cm}
    \Image<1>{4cm}{img/replace_me_with_anything_you_want}
    \Image<2-3>{4cm}{img/replace_me_with_anything_you_want}
    \Image<4>{4cm}{img/replace_me_with_anything_you_want}
    \Image<5>{4cm}{img/replace_me_with_anything_you_want}
    \Image<6-7>{4cm}{img/replace_me_with_anything_you_want}
    \Image<8>{4cm}{img/replace_me_with_anything_you_want}
    \Image<9>{4cm}{img/replace_me_with_anything_you_want}
  \end{flushleft}%
  \end{minipage}
  \>%
\)%
...
\end{flushleft}
  ...
  \begin{flushleft}%
    ...
    \vspace{-2.8cm}
    \hspace{1cm}
    \Image<3->{3.4cm}{img/replace_me_with_anything_you_want}~\\
    \vspace{-2.4cm}
    \hspace{2cm}
    \Image<4->{3cm}{img/replace_me_with_anything_you_want}~\\
  \end{flushleft}%
  \end{minipage}
  \>%
\)%
...
\vspace{-3.2cm}
\hspace{5.7cm}
\Image{3.9cm}{img/replace_me_with_anything_you_want}%
\end{onlyenv}
\begin{onlyenv}<9>
\vspace{-2.88cm}
\hspace{6.1cm}
\Image{3.5cm}{img/replace_me_with_anything_you_want}%
\end{onlyenv}
\end{center}
\end{frame}
...
\vspace{-.5cm}
\hspace{-2cm}
\Image{2cm}{img/replace_me_with_anything_you_want}
\end{center}
\end{onlyenv}
\end{frame}
...
\begin{onlyenv}<1>
\hspace{5cm}
\Image{3.2cm}{img/replace_me_with_anything_you_want}%
\end{onlyenv}
\begin{onlyenv}<2>
\hspace{5cm}
\Image{3.2cm}{img/replace_me_with_anything_you_want}%
...
\vspace{0.6cm}
\hspace{5cm}
\Image{2.6cm}{img/replace_me_with_anything_you_want}%
\end{onlyenv}
\end{center}
\end{minipage}
\end{frame}
